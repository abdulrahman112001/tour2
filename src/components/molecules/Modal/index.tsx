    ...
    <Transition.Root appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-[9999999] " onClose={onClose}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-black bg-opacity-25 p" />
        </Transition.Child>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className="w-full max-w-4xl  overflow-y-scroll transform rounded-md bg-white 
                text-left align-middle shadow-xl transition-all sm:my-8 sm:max-w-1xl"
              >
                <Dialog.Title
                  as="h3"
                ...
                >
                  ...
                  <button
                    type="button"
                    className="absolute top-[10px] right-[20px]  z-[99]"
